...
@section('content')
    ...
    <div class="flex flex-wrap">
        @foreach ($articles as $article)
            <div class="max-w-2xl flex flex-col justify-between my-5 px-8 py-4 mx-auto bg-gray-100 rounded-lg shadow-md dark:bg-gray-800">
                ...
                <div class="flex justify-end">
                    <a href="/article/{{$article->id}}" class="text-white bg-green-700 mr-2 px-2 rounded">Lire l'article</a>
                    <a href="/article/{{$article->id}}/edit" class="text-white bg-black mr-2 px-2 rounded">Modifier l'article</a>
